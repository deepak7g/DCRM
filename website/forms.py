...
class SignUpForm(UserCreationForm):
	...
	def __init__(self, *args, **kwargs):
		...
		self.fields['username'].help_text = '<p class="form-text text-muted"><p>Required. 150 characters or fewer. Letters, digits and @/./+/-/_ only.</p></p>'
		...
		self.fields['password2'].help_text = '<p class="form-text text-muted"><p>Enter the same password as before, for verification.</p></p>'	
